...
void Menu() {
    ...
    printBorder(width);
    cout << endl;
    cout << setw(90) << "~~~~~ВЫБЕРЕТЕ~~~~~\n\n";
    printBorder(width);
    cout << endl;
    cout << setw(92) << "~~~ 1. Начать игру  ~~~\n\n";
    cout << setw(94) << "~~~ 2. Прочитать правила ~~~\n\n";
    cout << setw(87) << "~~~ 3. Выйти ~~~\n\n\n";
    cout << setw(80) << "Выберете: ";
}
...
Statistics game(int players_ammount, Statistics names)
{
    ...
    while (true)
    {
        ...
        while (true)
        {
            ...
            printBorder(width);
            cout << endl; 
            cout << setw(80) << "~~~Ход игрока: " << names.names[id] << " ~~~\n\n"; 
            printBorder(width);   
...
string word_input_simpel_check(Player& player, Player player_arr[], char letter_bank[], short player_ammount, Statistics score, short player_id, short letter_ammount) {
    ...
    while (!check_complited) {
        ...
        if (!already_dumb && player.bonuces != 3) {
            cout << "                                              Введите слово из ваших 10-ти букв или воспользуйтесь бонусом\n\n ";
            cout << setw(74) << " "; 
          }
        else
            cout << "                                               Введите слово из ваших 10-ти букв или воспользуйтесь бонусом: ";
